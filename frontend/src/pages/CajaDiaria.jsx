                    ...
                    <>
                        ...
                        <div style={s.seccion}>
                            ...
                            <div style={s.tablaFila3Cols}>
                                ...
                                <span style={{ ...s.muted, ...s.textCenter }}>{data.egresos.devoluciones.cantidad} cambio{data.egresos.devoluciones.cantidad !== 1 ? 's' : ''}</span>
                                <span style={{ fontWeight: '600', color: '#e53935', ...s.textRight }}>
                        ...
                        <div style={{ ...s.seccion, border: '1.5px solid #1565c0' }}>
                            ...
                            {[
                                ...
                                { label: 'Devoluciones',         val: data.egresos.devoluciones.total,      signo: '−', color: '#e53935' },
...
const s = {
    ...
    // NUEVOS ESTILOS PARA ALINEACIÓN PERFECTA DE 3 COLUMNAS:
    ...
    // Resumen final (Solo usa 2 columnas)
    ...
    // Utilidades de texto para las columnas
